...
// August 13, 2026 publication batch. The fifth field is deliberately part of
// each source record so the publication date cannot be inferred from a shared
// batch constant.
const aug13Topics = [
  ['ap-invoice-tax-code-evidence-review', 'AP invoice tax-code evidence review', 'invoice tax-code evidence review', 'Compare tax fields with the source invoice and record the evidence needed for a finance owner to resolve uncertainty.', '2026-08-13'],
  ['ap-invoice-remittance-reference-trail', 'AP invoice remittance reference trail', 'invoice remittance reference trail', 'Connect invoice references to remittance records so a reviewer can trace the prepared item without relying on memory.', '2026-08-13'],
  ['ap-vendor-trading-name-record-check', 'Vendor trading-name record check for AP', 'vendor trading-name record check', 'Compare trading and legal names with approved records and document the difference before the packet moves forward.', '2026-08-13'],
  ['ap-invoice-approver-roster-check', 'Invoice approver roster check for AP support', 'invoice approver roster check', 'Use the current approval roster to confirm ownership and stop when the responsible approver is unclear.', '2026-08-13'],
  ['ap-goods-receipt-timing-review', 'Goods-receipt timing review for AP matching', 'goods-receipt timing review', 'Compare order, receipt, and invoice timing to isolate a specific gap for the accountable owner.', '2026-08-13'],
  ['ap-invoice-shipping-charge-evidence', 'Invoice shipping-charge evidence review', 'invoice shipping-charge evidence', 'Separate shipping charges from goods or services and identify the source needed to support the difference.', '2026-08-13'],
  ['ap-supplier-credit-note-reconciliation', 'Supplier credit-note reconciliation index', 'supplier credit-note reconciliation', 'Link credit notes to statements and invoices so open credits remain visible through reconciliation.', '2026-08-13'],
  ['ap-invoice-attachment-integrity-check', 'Invoice attachment integrity check', 'invoice attachment integrity check', 'Compare repeated files and versions while retaining the original attachment for an accountable review.', '2026-08-13'],
  ['ap-close-unbilled-service-evidence-log', 'AP close unbilled-service evidence log', 'close unbilled-service evidence log', 'Record open service evidence and owner responses needed for a finance close decision.', '2026-08-13'],
  ['ap-invoice-cost-center-evidence-review', 'Invoice cost-center evidence review', 'invoice cost-center evidence review', 'Check cost-center coding against approved records and isolate judgment calls for the finance reviewer.', '2026-08-13'],
  ['ap-supplier-statement-invoice-gap-register', 'Supplier statement invoice-gap register', 'supplier statement invoice-gap register', 'Turn statement gaps into specific invoice requests with owners, dates, and retrievable evidence.', '2026-08-13'],
  ['ap-invoice-approval-rationale-record', 'Invoice approval rationale record', 'invoice approval rationale record', 'Capture the decision-maker, reviewed record, decision date, and unresolved question in one traceable note.', '2026-08-13'],
  ['ap-payment-batch-control-exception-list', 'Payment-batch control exception list', 'payment-batch control exception list', 'Prepare a review list for missing approvals, changed details, and duplicate risks before authorized release.', '2026-08-13'],
  ['ap-invoice-supplier-id-verification', 'Invoice supplier-ID verification checklist', 'invoice supplier-ID verification', 'Compare supplier identifiers with approved records and pause unexpected changes for independent review.', '2026-08-13'],
  ['ap-open-invoice-next-owner-aging', 'Open-invoice next-owner aging review', 'open-invoice next-owner aging', 'Show how long an invoice has waited, who owns the next step, and which evidence is still missing.', '2026-08-13'],
  ['ap-approver-unavailable-escalation-path', 'Approver-unavailable escalation path for AP', 'approver-unavailable escalation path', 'Use a documented backup path for unavailable approvers without treating silence as approval.', '2026-08-13'],
  ['ap-close-population-completeness-check', 'AP close population completeness check', 'close population completeness check', 'Check the close population for source invoices, status, owner notes, and unresolved exceptions.', '2026-08-13'],
  ['ap-vendor-record-renewal-tracker', 'Vendor record renewal tracker for AP', 'vendor record renewal tracker', 'Track expiring vendor records and route renewals while acceptance remains with the authorized owner.', '2026-08-13'],
  ['ap-invoice-variance-tolerance-evidence', 'Invoice variance tolerance evidence review', 'invoice variance tolerance evidence', 'Make amount differences visible against documented rules instead of allowing support staff to approve exceptions.', '2026-08-13'],
  ['ap-reconciliation-difference-owner-log', 'AP reconciliation difference-owner log', 'reconciliation difference-owner log', 'Keep reconciling differences assigned with evidence, next action, and a dated finance decision.', '2026-08-13'],
  ['ap-invoice-source-file-cross-reference', 'AP invoice source-file cross-reference', 'invoice source-file cross-reference', 'Connect source files, invoice records, and exception notes so each prepared item remains reviewable.', '2026-08-13'],
  ['ap-vendor-payment-hold-evidence-review', 'Vendor payment-hold evidence review', 'vendor payment-hold evidence review', 'Document the reason, source evidence, owner, and release decision for a payment hold.', '2026-08-13'],
] as const;

export const aug13BlogPublicationDates: Record<string, string> = {
  'ap-invoice-tax-code-evidence-review': '2026-08-13',
  'ap-invoice-remittance-reference-trail': '2026-08-13',
  'ap-vendor-trading-name-record-check': '2026-08-13',
  'ap-invoice-approver-roster-check': '2026-08-13',
  'ap-goods-receipt-timing-review': '2026-08-13',
  'ap-invoice-shipping-charge-evidence': '2026-08-13',
  'ap-supplier-credit-note-reconciliation': '2026-08-13',
  'ap-invoice-attachment-integrity-check': '2026-08-13',
  'ap-close-unbilled-service-evidence-log': '2026-08-13',
  'ap-invoice-cost-center-evidence-review': '2026-08-13',
  'ap-supplier-statement-invoice-gap-register': '2026-08-13',
  'ap-invoice-approval-rationale-record': '2026-08-13',
  'ap-payment-batch-control-exception-list': '2026-08-13',
  'ap-invoice-supplier-id-verification': '2026-08-13',
  'ap-open-invoice-next-owner-aging': '2026-08-13',
  'ap-approver-unavailable-escalation-path': '2026-08-13',
  'ap-close-population-completeness-check': '2026-08-13',
  'ap-vendor-record-renewal-tracker': '2026-08-13',
  'ap-invoice-variance-tolerance-evidence': '2026-08-13',
  'ap-reconciliation-difference-owner-log': '2026-08-13',
  'ap-invoice-source-file-cross-reference': '2026-08-13',
  'ap-vendor-payment-hold-evidence-review': '2026-08-13',
};

const aug13Guidance: Record<string, {answer: string; sections: {title: string; paragraphs: string[]}[]}> = Object.fromEntries(
  aug13Topics.map(([slug, title, keyword, excerpt], index) => [slug, {
    answer: `${excerpt} The support role prepares the evidence trail and routes the item; the finance owner decides whether the transaction or change is accepted.`,
    sections: [
      {title: 'Start with the source record', paragraphs: [`For ${keyword}, define the exact source record before anyone prepares a queue item. Record where it arrived, what identifier connects it to the vendor or invoice, and which required fields must be present.`, `The working question for this lane is specific: ${excerpt} A useful packet lets a reviewer move from the prepared field back to the original document. Preserve the original wording and attachment rather than replacing it with a summary.`]},
      {title: 'Write the stop condition', paragraphs: [`The support role can compare records, note a discrepancy, request missing evidence, and assign the next owner. It should stop when the source is uncertain, a high-risk field changes, or the evidence does not support the requested action.`, `Put the stop reason in the queue using observable facts: missing page, different amount, unmatched identifier, unclear period, or an unverified request. Avoid labels that imply a decision has already been made.`]},
      {title: 'Keep the owner decision visible', paragraphs: [`Route the completed packet to the named finance owner with the question stated in one sentence. A reviewer should not need to reconstruct the issue from scattered messages or infer who has authority.`, `For a Philippines-based support lane, document the handoff window, approved system, backup contact, and how an unresolved item is returned to the queue. This makes time-zone coverage useful without transferring approval authority.`]},
      {title: 'Review the evidence trail', paragraphs: [`Sample finished and stopped items against the source record. Check whether the note explains what was compared, whether the link or location is retrievable, and whether the next action has an owner and date.`, `If the same question appears repeatedly, update the written lane rule and show the change to the reviewer. Keep access limited to the systems and documents needed for this specific task.`]},
    ],
  }])
);
...
export const batchPosts = allTopics
  ...
  .sort((a, b) => {
    ...
    return allTopics.findIndex(([slug]) => slug === a.slug) - allTopics.findIndex(([slug]) => slug === b.slug);
  });
