...
import {notFound,redirect} from 'next/navigation';import {Header,Footer} from '../../../components';import {blogPosts} from '../../../data';import {aug31BlogPublicationDates} from '../../../blog-aug31-batch';import {aug23BlogPublicationDates} from '../../../blog-aug23-batch';import {aug20BlogPublicationDates} from '../../../blog-aug20-batch';import {aug21BlogPublicationDates} from '../../../blog-aug21-batch';import {aug18BlogPublicationDates} from '../../../blog-aug18-batch';import {aug17BlogPublicationDates} from '../../../blog-aug17-batch';import {aug14BlogPublicationDates,aug13BlogPublicationDates} from '../../../blog-batch';const acceptedBlogRank = new Map(
  [...Object.keys(aug31BlogPublicationDates).map((slug,index)=>[slug,index] as [string,number]),
  ...Object.keys(aug23BlogPublicationDates).map((slug,index)=>[slug,index+Object.keys(aug31BlogPublicationDates).length] as [string,number]),
  ...Object.keys(aug21BlogPublicationDates).map((slug,index)=>[slug,index+Object.keys(aug23BlogPublicationDates).length] as [string,number]),
