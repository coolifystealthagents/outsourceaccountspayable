...
3. Delivered locally, non-duplicable: `/research/ap-invoice-receipt-date-evidence-research` has one route-local handoff to `/services/month-end-ap-close-support`. Rendered-source commit `14b533cfa9e13c1317f9f06cc6d655be766fb961` adds it beside the receipt-date evidence guidance and keeps cutoff, accounting treatment, approval, and posting with the finance owner. The approved batched Coolify workflow owns deployment and public verification; do not add a second CTA.
