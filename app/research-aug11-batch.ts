...
export const aug11ResearchBatch:ResearchPost[] = [
  base('ap-invoice-date-validation-research','Invoice date validation in AP support','How to distinguish invoice-date evidence, service-period questions, and owner decisions before an invoice enters approval.','2026-08-11',[
  ...
  base('ap-remittance-address-research','Remittance-address verification research','A source-backed look at verifying remittance information while protecting the boundary around vendor changes and payment release.','2026-08-11',[
  ...
  base('ap-invoice-split-coding-research','Split-coding preparation research for invoices','How to prepare multi-line invoice coding evidence without turning a support role into the final accounting decision-maker.','2026-08-11',[
  ...
  base('ap-vendor-credit-balance-research','Vendor credit-balance follow-up research','A practical research model for locating open credits, linking them to invoices, and routing reconciliation decisions to finance owners.','2026-08-11',[
  ...
  base('ap-vendor-email-verification-research','Vendor-email verification controls research','How AP teams can separate ordinary vendor correspondence from requests that need independent verification or escalation.','2026-08-11',[
  ...
  base('ap-invoice-attachment-completeness-research','Invoice-attachment completeness research','A reviewable method for identifying missing invoice support before approval packets move forward.','2026-08-11',[
  ...
  base('ap-payment-status-inquiry-research','AP payment-status inquiry research','How to answer routine vendor status questions while keeping payment commitments, exceptions, and release decisions with authorized owners.','2026-08-11',[
  ...
  base('ap-vendor-w9-follow-up-research','Vendor W-9 follow-up research','A source-led approach to collecting missing W-9 information and routing tax-form questions without deciding vendor tax treatment.','2026-08-11',[
  ...
  base('ap-access-review-evidence-research','AP support access-review evidence research','What evidence helps a finance owner review whether AP support access still matches the assigned work.','2026-08-11',[
  ...
  base('ap-data-incident-invoice-records-research','Invoice-record data incident response research','How to organize the first evidence trail when invoice or vendor records may have been exposed or altered.','2026-08-11',[
