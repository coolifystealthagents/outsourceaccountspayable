    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Accounts payable control</p>
          <h1>Outsource Accounts Payable: an ap control room for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsource accounts payable guide for finance teams outsourcing invoice intake, approvals, and vendor follow-up. The page now uses a distinct invoice operations layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>invoice strips and approval stamps</figcaption></figure>
      </div>
    </section>
