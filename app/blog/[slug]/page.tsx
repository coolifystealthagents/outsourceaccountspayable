  ...
  return <>
    ...
    <main className="section article-page" data-article-marker={slug}>
      ...
      <article className="container guide-article">
        ...
        {(detail.sourceDate === '2026-09-07' || detail.sourceDate === '2026-09-08' || detail.sourceDate === '2026-09-09' || detail.sourceDate === '2026-09-10') && detail.thumbnail && <img src={detail.thumbnail} alt={`${post.title} illustration`} width="1200" height="630" style={{width:'100%',height:'auto'}}/>}
